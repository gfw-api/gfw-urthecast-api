...
This repository is the microservice that it implement the urthecast funcionality and exposed the /urthecast endpoints in the api-gateway

[View the documentation for this
API](http://gfw-api.github.io/swagger-ui/?url=https://raw.githubusercontent.com/gfw-api/gfw-urthecast-api/master/app/microservice/swagger.yml#/URTHECAST)

## First time user
Perform the following steps:
* [Install docker](https://docs.docker.com/engine/installation/)
* Clone this repository: ```git clone git@github.com:Vizzuality/gfw-urthecast-api.git```
* Enter in the directory (cd gfw-urthecast-api)
